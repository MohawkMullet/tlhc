			...
			<table width="100%" border="0" cellpadding="2" cellspacing="3" bgcolor="#cccccc" id="gradesAndKeys"><tr>
              <td colspan="3" bgcolor="#cccccc" height="28px" style="font:bolder; font-size:14px; background-image:url(http://i2.ebayimg.com/06/i/001/24/73/95f7_1_b.GIF);" class="blueFontBold">
			  <div align="center" >Grading & Abbreviations</div>
              </td>
              </tr>
              <tr>
                <td align="left" valign="top" bgcolor="#cccccc" style="width:25%">
<?php
include("gradesDefault.php");
?>
                  </td>
                <td align="left" valign="top" style="width:75%">
<!-- GraderKey Went HERE -->
<?php
include("commentkeyDefault.php");
?>
           		</td>
              </tr> 
			                      <tr>
