...
$search2 = "<a href=\"javascript:animatedcollapse.toggle('search2')\" target=\"mainFrame\" class=\"fg-button fg-button-icon-solo ui-state-default ui-corner-all\" title='Load the 45 Search Forms'><span class=\"ui-icon silk-icon-page-white-magnify\" title='Load the 45 Search Forms'></span>&nbsp;</a>";
