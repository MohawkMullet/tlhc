...
$helpButton = "<a href=\"javascript:animatedcollapse.toggle('helpDocs')\" target=\"mainFrame\" title='Load the Help Files' class=\"fg-button fg-button-icon-solo ui-state-default ui-corner-all tooltip\"><span class=\"ui-icon ui-icon-help\"  style='display:inline-block;'title='Load the Help Files' ></span>&nbsp;</a>";
