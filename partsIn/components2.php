<fieldset class="pane">
<legend>
			<a href="#" class="fg-button fg-button-icon-solo delete" title="Close this section">
				...
				Components:
					&nbsp;
			<a href="../docs/componentDesign.php" target="mainFrame" class="fg-button fg-button-icon-solo ui-state-default ui-corner-all" title="see the help file for components">
