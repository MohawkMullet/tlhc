...
<form name="tForm" method="post" action="copyPaste2.php" target="mainFrame" title="cardForm" class="tooltip">
<!-- <form name="tForm" method="post" action="right.php?showOut=True" target="mainFrame" title="cardForm">
 -->
 <input type="hidden" name= "itemType" value="computerCards">
 <input type="hidden" name= "templateName" value="cards">
