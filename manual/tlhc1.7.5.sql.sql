...
--
-- Host: localhost
-- Generation Time: Dec 07, 2008 at 01:49 AM
...
CREATE TABLE IF NOT EXISTS `commsLabel` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=109 ;
...
CREATE TABLE IF NOT EXISTS `commsPromo` (
  ...
  `name` varchar(200) default NULL,
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=508 ;
...
CREATE TABLE IF NOT EXISTS `commsVinyl` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC COMMENT='comments about the vinyl condition' AUTO_INCREMENT=104 ;
