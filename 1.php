								 <LINK REL="alternate" TYPE="application/rss+xml" title="Title of the feed (RSS 2.0)" HREF="
http://rss.api.ebay.com/ws/rssapi?FeedName=StoreItems&siteId=0&language=en-US&output=RSS20&storeId=480498590" />
<style type="text/css">
.greyFontLarge {
...
.plug {
	background-image: url(http://lh6.ggpht.com/_W_e1PG0tXUk/SYBSICFhGtI/AAAAAAAAAss/royRKyqgwYM/s288/raF32x45.jpg);
	background-repeat: no-repeat;
...
.bld {
	background-image: url(http://lh5.ggpht.com/_W_e1PG0tXUk/SYBSIGjYQlI/AAAAAAAAAs0/po9G9F7IJt8/s800/box1_08.jpg);
	background-repeat: repeat-x;
	padding-left: 20px;
}
.bldG {
	background-image: url(http://lh5.ggpht.com/_W_e1PG0tXUk/SYBSGOdwXMI/AAAAAAAAArs/UYRbqySANAI/s800/greenM.jpg);
	background-repeat: no-repeat;
	padding-left: 20px;
...
<table width="840px" align="center" border="0" cellpadding="0" cellspacing="0" id="header">
      ...
      </table><table align="center" cellspacing="6" class="whole" id="whole">
  <tr>
	<td>
	  ...
	  <tr>
		<td align="center" valign="top" style="padding-top:5px">
                    <div id="listingPic" align="center">
                    	<span class="imgB" align="center" title=""><img src="http://jqueryui.com/jquery-wp-content/themes/jquery/content/books/jquery-ui-in-action.jpg" style="overflow:hidden;" max-width="320px" max-height="320px" /></span>                    </div>
							<font color="#ffffff" size="1">
							10/31/2015 03:18:39 AM					  </font></td>
...
<span class="greyFont">OEM:</span><span class="blueFontBold"><strong>LENEL</strong></span>  <span class="greyFont">Item:</span><span class="blueFontBold"><strong>DVB-444 V1.2</strong></span></div>
<div id="mfgBox" style="float:left; clear:both;">
		<br><span class="greyFont">Chip MFG:  </span><span class="blueFontBold"><strong>HAUPPAUGE</strong></span></div><div id="lineBox" style="float:left; clear:both;">
<span class="greyFont">Rail Line:</span><span class="blueFontBold"><strong>Burlington Northern</strong></span>
</span><br></div>
<div id="mfgBox" style="float:left; clear:both;">
<span class="greyFont">Type:</span><span class="blueFontBold"><strong>PCI</strong></span>
</span><br></div>
<div id="upcBox" style="float:left; clear:both;">
<span class="greyFont">UPC Bar Code #:</span><span class="blueFontBold"><strong>1006701951411</strong></span>
</span><br></div>
			 </td>
		 </tr>
	  <tr>
						  ...
						  <tr>
							...
							<tr>
									<td height="98" class="bld" bgcolor="#4C81B7">
															<span class='greyFont'>Comments:</span><br><span class="multicomms">PCIe (PCI express)</span><br>
 

<br><br /><br /><a href=""></a><span class="greyFont">Condition:</span><span class="blueFontBold"><strong>Used - Like New</strong></span>
</span><br>    			
									</td>
							</tr>
							<tr>
