...
INSERT INTO `commsMisc` VALUES (1,'5 song EP','5 song EP'),(2,'4 Song EP','4 Song EP'),(3,'Stored in mylar protective clear outer jacket. ','Stored in mylar protective clear outer jacket. '),(16,'complete with lyric sheet','complete with lyric sheet'),(15,'fold open picture sleeve','fold open picture sleeve'),(14,'6 song EP','6 song EP'),(17,'black vinyl','black vinyl'),(26,'dsafffffffffffffffffffffffffffff','dsafffffffffffffffffffffffffffff'),(27,'bullhsit','bullhsit'),(28,'ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff','ffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffffff');
...
INSERT INTO `commsSolMisc` VALUES (1,'soldier has broken leg','soldier has broken leg'),(2,'soldier has broken foot','soldier has broken foot'),(3,'soldier has broken arm','soldier has broken arm'),(4,'missing one of the wheels','missing one of the wheels'),(5,'everything is screwed up','everything is screwed up'),(6,'Bitch','Bitch');
...
INSERT INTO `commsSolPaint` VALUES (1,'paint has faded quite badly','paint has faded quite badly'),(2,'paint is all chipped up','paint is all chipped up'),(3,'adfsssssssssssssssssssssssssssssssssssssssssssss','adfsssssssssssssssssssssssssssssssssssssssssssss');
...
INSERT INTO `commsTrainsAccess` VALUES (1,'Original instruction sheet included','Original instruction sheet included'),(2,'Includes original factory shipped extra screws and hardware','Includes original factory shipped extra screws and hardware'),(3,'Extra wheel included','Extra wheel included'),(4,'gggggf','gggggf');
...
INSERT INTO `commsTrainsPackaging` VALUES (1,'Foam core insert included','Foam core insert included'),(2,'Box is missing top','Box is missing top'),(3,'box is ripped in half','box is ripped in half');
...
-- Dump completed on 2015-10-04 17:55:22
