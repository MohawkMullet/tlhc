...
?>
<table cellpadding="4" cellspacing="0" border="4" bgcolor="#d9d9d9" width="80%" style="border-bottom-width: 0px; border-top-width: 0px; border-right-width:0px;"  id="descript" align="center">
  ...
  ?>
		...
		<tr bgcolor="#1C2D59">
			<th  bgcolor="#1C2C53" style="font:bolder; color:#ffffff; font-size:16px; border-style:groove; border-top-width:0px; border-bottom-width:2px; border-right-width:0px; border-top-width:2px; border-left-width:0px; border-color:#dcdcdc; border: 1px none #000000;">
					<?php
