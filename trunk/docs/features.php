...
<body>
 <p>What is It?</p>
 <p>A set of php scripts that run on apache with mysql (optional).</p>
 <p>What does it do?</p>
 ...
 <p>Custom CSS styles included in your listing</p>
 <p>Show Latest Listings in Description</p>
 <p>Show store categories</p>
 <p>Include Store Promotion Boxes</p>
 <p>Include subscription links (add to my yahoo, rss button, etc) </p>
 <p>Reusable comments easily included in listings</p>
 <p>Offsite images can be included in listings</p>
 <p>&nbsp; </p>
 <p>&nbsp; </p>
 <?php
include('footer.php');
