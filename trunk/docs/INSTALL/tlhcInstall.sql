...
CREATE TABLE IF NOT EXISTS `commsLabel` (
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC AUTO_INCREMENT=110 ;
...
CREATE TABLE IF NOT EXISTS `commsMisc` (
  `id` int(11) NOT NULL auto_increment,
...
INSERT INTO `commsMisc` (`id`, `value`, `name`) VALUES
...
CREATE TABLE IF NOT EXISTS `commsPromo` (
  `id` int(11) NOT NULL auto_increment,
...
INSERT INTO `commsPromo` (`id`, `value`, `name`) VALUES
...
(43, 'Demonstration Not For Sale both sides.', 'Demonstration Not For Sale both sides.'),
(56, 'For Radio Station Use Only on both sides.', 'For Radio Station Use Only on both sides.'),
(61, 'Radio Station Copy and Not For Sale both sides.', 'Radio Station Copy and Not For Sale both sides.'),
(77, 'DJ Copy', 'DJ Copy'),
(78, 'DJ Copy both sides.  Plug Side on A', 'DJ Copy both sides.  Plug Side on A'),
(500, 'Not For Resale and Radio Station Copy both sides.', 'Not For Resale and Radio Station Copy both sides.'),
(501, 'Not For Sale on both sides with PLUG SIDE on A.', 'Not For Sale on both sides with PLUG SIDE on A.'),
(6, 'Promotion Not For Sale', 'Promotion Not For Sale'),
(503, 'Special Rush Service', 'Special Rush Service'),
(4, 'Promotion Record and Not For Sale both sides', 'Promotion Record and Not For Sale both  sides'),
...
(7, 'promotion not for sale both sides', 'promotion not for sale both sides'),
(21, 'suggested side on a', 'suggested side on a'),
...
CREATE TABLE IF NOT EXISTS `commsSleeve` (
  `id` int(11) NOT NULL auto_increment,
...
INSERT INTO `commsSleeve` (`id`, `value`, `name`) VALUES
(1, 'sleeve in is in M- condition', 'sleeve in is in M- condition');



CREATE TABLE IF NOT EXISTS `commsVinyl` (
  `id` int(11) NOT NULL auto_increment,
  ...
  PRIMARY KEY  (`id`)
) ENGINE=MyISAM  DEFAULT CHARSET=latin1 ROW_FORMAT=DYNAMIC COMMENT='comments about the vinyl condition' AUTO_INCREMENT=109 ;



INSERT INTO `commsVinyl` (`id`, `value`, `name`) VALUES
(10, 'Vinyl is in perfect condition. Probably Never Been Played', 'what ever'),
...
CREATE TABLE IF NOT EXISTS `listings` (
  ...
  `songa` varchar(100) NOT NULL,
  `songb` varchar(100) NOT NULL,
...
INSERT INTO `listings` (`id`, `title`, `songa`, `songb`, `label`) VALUES
(1, 'this is a fake title', 'song a', 'flip side', 'columbia'),
(2, 'test', 'st', 'tse', 'stes'),
(3, 'adfsdfs', 'sdfdsf', 'dsfds', 'dsfdsf'),
(4, '', '', '', ''),
(5, 'dfsdfss', 'gdfssdgfdgfs', 'dgfsgdfsdgfs', 'sdgfdgfsdgfs'),
(6, '', '', '', '');
