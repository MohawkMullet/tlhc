<fieldset class="insideFields"><legend>SideBar, URL, & Link Descript:&nbsp;<a href="parts/start2.php" target="mainFrame" class="fg-button fg-button-icon-solo ui-state-default ui-corner-all"><span class="ui-icon ui-icon-extlink"></span>&nbsp;</a></legend>    
<?php
...
echo "<textarea name=\"sideBar2\" class=\"ui-widget textarea defaultText\" cols=\"41\" rows=\"2\" wrap=\"physical\" id=\"sideBar2\" tabindex=\"15\" title=\"Paste extra song or artist info here and provide link below\"></textarea>";
}
?>
