<fieldset class="insideFields"><legend>Components:&nbsp;<a href="../docs/componentDesign.php" target="mainFrame" class="fg-button fg-button-icon-solo ui-state-default ui-corner-all" title="see the help file for components"><span class="ui-icon ui-icon-wrench"></span>&nbsp;</a></legend>
...
<label><input class="ui-widget input" type="checkbox" name="boxes3" value="aboutUs" checked tabindex="19">About Us</label>
		<label><input type="checkbox" class="ui-widget input" name="boxes4" value="gradeKey" checked tabindex="19">Grades</label>
